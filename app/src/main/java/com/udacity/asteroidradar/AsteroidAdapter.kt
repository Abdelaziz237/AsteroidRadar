...
class AsteroidAdapter(private val listener: OnClickListener): ListAdapter<Asteroid, AsteroidAdapter.AsteroidViewHolder>(DiffCallback) {
    ...
    override fun onBindViewHolder(holder: AsteroidViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            listener.clickListener(asteroid)
        }
    }
